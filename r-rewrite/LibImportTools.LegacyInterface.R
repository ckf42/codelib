...
.LibImportTools.LegacyInterface.Const.ReplacementDict = list(
    ...
    "Graph.Plot.clusterResult" = "plot_cluster",
    "Graph.Plot.overlapCommunity" = "plot_overlapComm",
    "Graph.Plot.overlapCommunityFromAlgo" = "plot_overlapComm_algo",
    "Graph.Plot.plotAfterClustering" = "plot_after_clustering",
